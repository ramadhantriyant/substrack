...
>
	<div class="w-full max-w-md rounded-2xl border border-[#1e293b] bg-[#0a0f1e] p-6 shadow-2xl">
		<div class="mb-6 flex items-center justify-between">
			<h2 class="text-lg font-semibold text-[#f1f5f9]">Add Subscription</h2>
			<button
				onclick={onClose}
				aria-label="Close"
		...
		>
			...
			<div>
				<label for="sub-category" class="mb-1 block text-sm text-[#64748b]">Category</label>
				<select
					id="sub-category"
					bind:value={category}
					class="w-full rounded-lg border border-[#1e293b] bg-[#0f172a] px-3 py-2 text-[#f1f5f9] transition-colors focus:border-[#f59e0b] focus:outline-none"
			...
			<div>
				<label for="sub-billing" class="mb-1 block text-sm text-[#64748b]">Next Billing Date</label>
				<input
					id="sub-billing"
					type="date"
